...
برگرداندن شاخه فعلی به یک کامیت قبل از کامیت فعلی با حذف تاریخچه کامیت های اضافی
...
فایل را به نسخه ای از آن در یک کامیت مشخص برمیگرداند.
...
مرحله ی Stage یا Index مرحله‌ای است که تغییرات قبل از commit شدن قرار می‌گیرند. این مرحله به شما امکان می‌دهد که تغییرات خاصی را برای commit بعدی آماده کنید.

6.

دستور stash تغییرات فعلی شما را موقتاً ذخیره می‌کند و شاخه کاری شما را به آخرین commit بازمی‌گرداند. این باعث می‌شود که بتوانید به راحتی به یک شاخه دیگر سوئیچ کنید یا روی مسائل دیگر کار کنید بدون اینکه تغییرات محلی‌تان از بین بروند.

7.

یک Snapshot در گیت به معنای یک تصویر از تمامی فایل‌های پروژه در یک زمان خاص است. هر commit در گیت یک snapshot از پروژه در زمان خاصی است. زمانی که یک commit ایجاد می‌کنید، گیت یک snapshot از وضعیت فعلی پروژه می‌گیرد و آن را به همراه پیام commit و اطلاعات دیگر ذخیره می‌کند.

8.

لوکال ریپازیتوری Local Repository

ریپازیتوری محلی یا Local Repository، همان فضایی است که بر روی دستگاه شما، مانند کامپیوتر شخصی یا لپ‌تاپ، قرار دارد. اینجا تمامی فایل‌ها، تاریخچه commit‌ها، تغییرات و برنچ‌های مختلف نرم‌افزار که شما در حال توسعه آن هستید، ذخیره می‌شوند. به عبارت دیگر، اینجا جایی است که شما به تنهایی روی کد کار می‌کنید و تغییرات را ذخیره می‌کنید بدون اینکه به مخاطبین دیگری دسترسی داشته باشند.

ریموت ریپازیتوری Remote Repository

ریپازیتوری از راه دور یا Remote Repository، یک ریپازیتوری است که بر روی یک سرور یا سرویس مانند GitHub، GitLab یا Bitbucket قرار دارد. این ریپازیتوری برای اشتراک‌گذاری کد با سایر توسعه‌دهندگان و همچنین برای همکاری و مدیریت تغییرات استفاده می‌شود. شما می‌توانید تغییرات خود را به این ریپازیتوری push کنید تا سایر اعضای تیم بتوانند آن را مشاهده و از آن استفاده کنند، همچنین می‌توانید از این ریپازیتوری fetch و pull کنید تا تغییرات جدید اعضای تیم را دریافت کنید و با کد خود همگام شوید.
