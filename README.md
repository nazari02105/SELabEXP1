...
<p>
  fetch: دریافت تغییرات از remote repository بدون merge.
pull: دریافت تغییرات از remote repository و merge آن با شاخه فعلی.
merge: ترکیب دو شاخه.
rebase: منتقل کردن تغییرات شاخه‌ای به ابتدای شاخه دیگر.
cherry-pick: اعمال یک یا چند commit خاص از یک شاخه به شاخه دیگر.
</p>
